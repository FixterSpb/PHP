        ...
        <div class="top">
                    ...
                    <ul class="menu">
                        <li class="menu_list">
                            ...
                            <div class="drop pos_top36">
                                ...
                                <div class="drop_flex">
                                    <?php foreach ($dropMenu as $key => $items):?>
                                        <h3 class="drop_title"><?= $key ?></h3>
                                        <ul class="drop_menu">
                                            <?php foreach ($items as $item): ?>
                                                <li class="drop_list">
                                                    <a href="<?= $item['url'] ?>" class="drop_link link_hover">
                                                        <?= $item['text'] ?>
                                                    </a>
                                                </li>
                                            <?php endforeach; ?>
            ...
            <nav class="center">
                <ul class="menu">
                    ...
                    <li class="menu_list">
                        <a href="<?= $item["url"] ?>"
                                class="menu_link <?= ($item['text'] === $page ? 'menu_link_active' : "") ?>">
                            <?= $item["text"]?>
                        </a>
                        <?php if (isset($item['menu'])): ?>
                            <div class="drop">
                                <?php foreach($item["menu"] as $column): ?>
                                    <div class="drop_flex">
                                        <?php foreach($column as $submenuItem): ?>
                                            <?php if (isset($submenuItem["title"])): ?>
                                                <h3 class="drop_title"><?= $submenuItem["title"] ?></h3>
                                                <ul class="drop_menu">
                                                <?php foreach($submenuItem["submenu"] as $link): ?>
                                                    <li class="drop_list">
                                                        <a href="<?= $link['url'] ?>" class="drop_link link_hover"><?= $link['text'] ?></a></li>
                                                <?php endforeach; ?>
                                                </ul>
                                            <?php elseif ($submenuItem["img"]): ?>
                                                <div class="drop_img_box">
                                                    <img src="<?= $submenuItem["img"] ?>" alt="<?= $submenuItem["alt"] ?>">
